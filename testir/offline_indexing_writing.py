...
output_dir = 'output'
docs_dict2 = joblib.load(os.path.join(output_dir, 'docs_dict_writing.joblib'))  

all_text =[]
for x in range(199993):
...
joblib.dump(vectorizer, os.path.join(output_dir, 'vectorizer_writing.joblib'))
joblib.dump(tfidf_matrix, os.path.join(output_dir, 'tfidf_matrix_writing.joblib'))
