...
collection_df = pd.read_csv(r'C:/Users/DELL/Desktop/IR/lotte/lotte/lifestyle/dev/collection.tsv', sep='\t', header=None, names=['pid', 'text'])
...
joblib.dump(docs_dict2, os.path.join(output_dir, 'docs_dict.joblib'))
print("file loaded ! this operation take",time.time()-start,"seconds")