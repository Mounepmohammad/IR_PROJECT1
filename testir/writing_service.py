...
def load_data(output_dir):
    ...
    docs_dict = joblib.load(os.path.join(output_dir, 'docs_dict_writing2.joblib'))
    tfidf_matrix = joblib.load(os.path.join(output_dir, 'tfidf_matrix_writing2.joblib'))
    vectorizer = joblib.load(os.path.join(output_dir, 'vectorizer_writing2.joblib'))
...
# Load queries
questions = []
with open('C:/Users/DELL/Desktop/IR/lotte/lotte/writing/test/qas.search.jsonl', 'r', encoding='utf-8') as f:
    for line in f:
...
mapfile = "C:/Users/DELL/Desktop/IR/testir/evaluation1/MAP_writing.txt"
recallfile = "C:/Users/DELL/Desktop/IR/testir/evaluation1/recall_writing.txt"
pricisionfile = "C:/Users/DELL/Desktop/IR/testir/evaluation1/pricision_writing.txt"
total_precision = 0.0
total_recall = 0.0
total_map = 0.0
i = 0
